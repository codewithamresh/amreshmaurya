...
export const Hero = ({ isDark, isVisible }: HeroProps) => {
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-5xl mb-12">
          ...
          >
            <p className={`text-xl md:text-2xl font-light ${subTextColor} max-w-2xl leading-relaxed`}>
              I'm <span className={`font-semibold ${textColor}`}>Amresh Maurya</span>, 
              a Backend Engineer with a background in <span className="text-blue-500 font-medium italic underline decoration-blue-500/20">Systems Consulting</span> and 
              a year of <span className="text-purple-500 font-medium">Technical Education</span>. 
     ...
     <div className={`grid grid-cols-1 sm:grid-cols-3 gap-8 mb-16 py-10 border-y transition-all duration-1000 delay-500 ${
  ...
  <div className="group flex flex-col items-center md:items-start">
    <div className="flex items-baseline gap-1">
      <p className="text-4xl font-black bg-clip-text text-transparent bg-gradient-to-b from-blue-400 to-blue-600">3+</p>
      <span className="text-sm font-bold text-blue-500/50">Mo.</span>
    </div>
    <p className={`text-[10px] mt-2 uppercase tracking-[0.3em] font-black ${subTextColor} group-hover:text-blue-500 transition-colors`}>
      Systems Consulting
    </p>
  ...
  <div className="group flex flex-col items-center md:items-start">
    <div className="flex items-baseline gap-1">
      <p className="text-4xl font-black bg-clip-text text-transparent bg-gradient-to-b from-purple-400 to-purple-600">1+</p>
      <span className="text-sm font-bold text-purple-500/50">Yr.</span>
    </div>
    <p className={`text-[10px] mt-2 uppercase tracking-[0.3em] font-black ${subTextColor} group-hover:text-purple-500 transition-colors`}>
      Technical Pedagogy
    </p>
  ...
  <div className="group flex flex-col items-center md:items-start">
    <div className="flex items-baseline gap-1">
      <p className="text-4xl font-black bg-clip-text text-transparent bg-gradient-to-b from-green-400 to-green-600">100%</p>
    </div>
    <p className={`text-[10px] mt-2 uppercase tracking-[0.3em] font-black ${subTextColor} group-hover:text-green-500 transition-colors`}>
    ...
    <div className="h-0.5 w-0 group-hover:w-12 bg-green-500 transition-all duration-500 mt-1" />
        ...
        >
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            ...
            >
              <div className="relative z-10">
                <p className="text-[10px] font-mono opacity-80 mb-1 tracking-widest uppercase">cat ./technical-logs.md</p>
          ...
          {/* Skill/Quote Card */}
          <div className={`md:col-span-7 p-8 border rounded-3xl flex flex-col justify-between backdrop-blur-md ${cardBg}`}>
            <div className="flex justify-between items-start mb-8">
              <div className={`p-3 rounded-xl ${isDark ? "bg-white/5" : "bg-black/5"}`}>
                <Terminal className="w-6 h-6 text-blue-500" />
              </div>
              <div className="flex flex-wrap gap-2 justify-end max-w-[200px]">
                {["TypeScript", "Node.js", "PostgreSQL", "React"].map((tech, i) => (
                  <div
                    key={i}
            ...
            <div>
              <p className={`text-xl font-mono mb-4 leading-tight italic ${textColor}`}>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className={`text-[10px] uppercase tracking-[0.25em] font-black ${subTextColor}`}>
